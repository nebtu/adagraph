...
To work with the trial in `adagraph`, we first need to make a
`trial_design` object with which we save all our prespecified trial
specifications.

First, we define the names of our arms and endpoints, so we can
...
Figure 1: Graph for the testing procedure we are using, generated using
the
...
to also check for effects specifically in the subgroup of patients
testing positive for the human papilloma virus (HPV+). Doing this is
...
#> sec_high       0.0000000 0.3333333      0.0     0.0      0.3333333
#> sec_low        0.3333333 0.0000000      0.0     0.0      0.3333333
#> HPV+_prim_high 0.2000000 0.2000000      0.0     0.0      0.0000000
#> HPV+_prim_low  0.2000000 0.2000000      0.0     0.0      0.2000000
#> HPV+_sec_high  0.3333333 0.3333333      0.0     0.0      0.0000000
#> HPV+_sec_low   0.3333333 0.3333333      0.0     0.0      0.3333333
#>                HPV+_prim_low HPV+_sec_high HPV+_sec_low
#> prim_high          0.2000000           0.0          0.0
#> prim_low           0.2000000           0.0          0.0
#> sec_high           0.3333333           0.0          0.0
#> sec_low            0.3333333           0.0          0.0
#> HPV+_prim_high     0.2000000           0.4          0.0
#> HPV+_prim_low      0.0000000           0.0          0.4
...
#> sec_high              NA        NA 1.0000000 0.5000000             NA
#> sec_low               NA        NA 0.5000000 1.0000000             NA
#> HPV+_prim_high 0.6546537 0.3273268        NA        NA      1.0000000
#> HPV+_prim_low  0.3273268 0.6546537        NA        NA      0.5000000
#> HPV+_sec_high         NA        NA 0.6546537 0.3273268             NA
#> HPV+_sec_low          NA        NA 0.3273268 0.6546537             NA
#>                HPV+_prim_low HPV+_sec_high HPV+_sec_low
#> prim_high          0.3273268            NA           NA
#> prim_low           0.6546537            NA           NA
#> sec_high                  NA     0.6546537    0.3273268
#> sec_low                   NA     0.3273268    0.6546537
#> HPV+_prim_high     0.5000000            NA           NA
...
#> 3       sec_high Total      sec high
#> 4        sec_low Total      sec  low
#> 5 HPV+_prim_high  HPV+     prim high
...
Figure 2: Graph for the testing procedure we are using, generated using
the
[`export_graphical_mcp()`](https://nebtu.github.io/adagraph/reference/export_graphical_mcp.md)
function

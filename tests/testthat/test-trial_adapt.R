test_that("can adapt n", {
  ...
  ad_n_table <- design$n_table
  ad_n_table$n <- ad_n_table$n * 2

  design_ad <- trial_adapt_n(design, ad_n_table = ad_n_table)
...
test_that("basic example dropping groups", {
  ...
  des_ad <- des |> trial_drop_groups("HPV+")
  ad_m <- rbind(
...
test_that("basic example dropping arms", {
  ...
  des_ad <- des |> trial_drop_arms("arm2")
  #fmt: skip
  ad_m <- rbind(
...
test_that("basic example dropping endpoints", {
  ...
  des_ad <- des |> trial_drop_endpoints("sec")
  ad_m <- rbind(
